...
export default class ClientCalendar extends React.Component {
    ...
    //use idCompany in cookie to request company data
    ...
    componentDidMount() {
        ...
        if (!this.props.clientAuthenticated) {
            ...
            let idCompany = document.cookie.split('; ').find(row => row.startsWith('idCompany=')).split('=')[1];
            const headers = {
        ...
        return (
            <div className="calendar_holder">
                <div className="sidebar">
                    ...
                    <img src={`http://localhost:5000/images/${this.props.location.state.CompanyInfo.companyLogo}`} alt="" />
