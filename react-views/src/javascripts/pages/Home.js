...
function App() {
  ...
  return (
    <div>  
      ...
      <div className="link">
        <a  href={link} id="link" onClick={scrollDown}>Learn more<br />
      ...
      <div id="infomenu">
        ...
        <div className="infosection">
          ...
          <div className="scroller" onClick={scrollUp}><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
